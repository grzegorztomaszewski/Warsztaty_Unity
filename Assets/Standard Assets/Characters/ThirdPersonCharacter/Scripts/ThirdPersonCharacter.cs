				...
				if (Physics.SphereCast(crouchRay, m_Capsule.radius * k_Half, crouchRayLength, Physics.AllLayers, QueryTriggerInteraction.Ignore))
				{
					m_Crouching = true;
                                        ...
                                        void Update()
                                        {
                                            ...
                                            transform.Translate(Vector3.forward * speed * Input.GetAxis("Vertical") * Time.deltaTime); // poruszanie przód ty³
                                            ...
                                            ammoText.text = "AMMO: " + ammo; // dodaje liczbe amunicji do obiektu "Text ammoText", któr¹ wyœwietla na ekranie 
                                            ...
                                            if (Input.GetKeyDown(KeyCode.F) && ammo > 0)
                                            {
                                                ...
                                                ammo--; // za ka¿dym strza³em odejmuje 1 ammo
                                                ammoSlider.value -= 1;
                                            }
